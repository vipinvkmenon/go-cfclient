...
const (
	...
	validAssertionToken = `eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZSI6IkpvaG4gRG9lIiwiYWRtaW4iOnRydWUsImlhdCI6MTUxNjIzOTAyMn0.KMUFsIDTnFmyG3nMiGM6H9FNFUROf3wh7SmqJp-QV30`
...
func TestTokenSource(t *testing.T) {
	...
	t.Run("Test JWTAssertionTokenSource invalid encoding", func(t *testing.T) {
		...
		_, err := src.Token()
		require.EqualError(t, err, "invalid base64 encoding in part \x03")
